...
{
    public abstract class BaseAppCenterRep<TType> : BaseMysqlRep<TType, long>
        where TType : BaseOwnerMo<long>, new()
    {
        ...
        protected BaseAppCenterRep(string tableName) : base(_writeConnection, _readConnection, tableName)
        {
        }
    }
}
