...
{
    [TestClass]
    public class SpuCategoryTest : BaseTest
    {
        private static readonly SpuCategoryService _service = new SpuCategoryService();
        ...
        public async Task TestMethod1()
        {
            ...
            var cId = addRes.data;
            var updateRes = await _service.UpdateName(cId, new UpdateCategoryNameReq()
            {
                name = "总分类（修改）"
            });
