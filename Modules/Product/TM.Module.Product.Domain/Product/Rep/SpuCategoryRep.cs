...
/// <summary>
///  ProductCategory 对象仓储
/// </summary>
public class SpuCategoryRep : BaseProductRep<SpuCategoryMo,long> 
{
    /// <inheritdoc />
    public SpuCategoryRep() : base("product_spu_category")
    {
    }
    ...
    /// <returns></returns>
    public Task<PageList<SpuCategoryMo>> Search(SearchReq req)
    {
