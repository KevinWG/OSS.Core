...
namespace OSS.Core.Reps.Basic.Portal
{
    ...
    ///  后台管理员仓储实现
    /// </summary> 
    public class AdminInfoRep : BaseMysqlRep<AdminInfoRep, AdminInfoMo,long>
    {
        ...
        public AdminInfoRep() : base(_writeConnection, _readConnection)
        {
        }
        ...
        public Task<Resp<AdminInfoMo>> GetAdminByUId(long uId)
        {
            ...
            Func<Task<Resp<AdminInfoMo>>> getFunc = () => Get(a => a.id == uId);
