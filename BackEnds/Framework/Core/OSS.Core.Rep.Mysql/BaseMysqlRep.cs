...
{
    public abstract class BaseMysqlRep<TRep, TType, IdType> : BaseRep<TRep, TType, IdType>
        ...
        where TType :  BaseMo<IdType>, new()
    {
        ...
        protected BaseMysqlRep(string writableConnection,string readableConnection)
        {
