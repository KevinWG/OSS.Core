...
import { outLogin } from '@/pages/portal/login/service';
...
const loginOut = async () => {
  ...
  if (window.location.pathname !== PortalConfig.login_url) {
    history.replace({
      pathname: PortalConfig.login_url,
      search: stringify({
...
const AvatarDropdown: React.FC<GlobalHeaderRightProps> = ({ menu }) => {
  ...
  const onMenuClick = useCallback((event: ClickParam) => {
    ...
    history.push(`/portal/admin/myprofile`);
  }, []);
