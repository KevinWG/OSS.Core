...
namespace OSS.Core.CoreApi.Controllers.Basic.Portal
{
    ...
    public class AdminController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [UserFunc(CoreFuncCodes.Portal_Admin_Create)]
        ...
        [HttpPost]
        [UserFunc(CoreFuncCodes.Portal_Admin_List)]
        ...
        /// <returns></returns>
        [HttpPost]
        [UserFunc(CoreFuncCodes.Portal_Admin_Lock)]
        ...
        /// <returns></returns>
        [HttpPost]
        [UserFunc(CoreFuncCodes.Portal_Admin_UnLock)]
        ...
        /// <returns></returns>
        [HttpPost]
        [UserFunc(CoreFuncCodes.Portal_Admin_SetType)]
